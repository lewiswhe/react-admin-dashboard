...
import { SankeyData as data } from "../data/nivoSankeyM_Non-Planar.js"


const SankeyChartNM = ({ isCustomLineColors = false, isDashboard = true }) => {
